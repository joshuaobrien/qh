...
export const HotelListingsSorderOrderSelector = ({ sortOrder, setSortOrder }: HotelListingsSorderOrderSelectorProps) => {
  const onChange = (e: ChangeEvent<HTMLSelectElement>) => setSortOrder(e.target.value as 'high-first' | 'low-first')
  return (
    <div>
      <span>Sort by </span>
